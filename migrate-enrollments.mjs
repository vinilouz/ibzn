...
async function runMigration() {
  console.log('🚀 Iniciando migration: Add participant_id to course_enrollments');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  try {
    ...
    const existingConstraint = await sql`
      ...
      AND constraint_name = 'course_enrollments_participant_id_fk'
    `;
    ...
    console.log('\n📊 Verificando estrutura da tabela course_enrollments...');
    ...
    console.log('\n📋 Colunas da tabela course_enrollments:');
    columns.forEach(col => {
    ...
    console.log('\n📌 Agora os participantes podem ser matriculados em cursos!');
